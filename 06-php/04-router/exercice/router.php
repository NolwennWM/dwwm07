...
function route($route, $path_to_include){
  ...
  /*
    Ce routeur utilise cette variable pour indiquer la racine du projet.
    Il est possible de la changer d'une de ces deux façons
    pour indiquer au routeur que notre projet commence ici.
  */
  // $ROOT = $_SERVER['DOCUMENT_ROOT']."/04-routeur/exercice";
  $ROOT = __DIR__;
  if($route == "/404"){
